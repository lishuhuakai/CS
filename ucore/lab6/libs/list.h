 ...
 * */
 ...
 // 简单的双向链表的实现
 // 基本上是关于链表的一些简单的操作，没什么好说的。

struct list_entry {
    struct list_entry *prev, *next;
};

typedef struct list_entry list_entry_t; // 我发现命名的规则非常有意思，一般都在后面添加_t
...
list_init(list_entry_t *elm) {
    elm->prev = elm->next = elm; // 初始化的话，指向自己是吧！
}
...
list_add_after(list_entry_t *listelm, list_entry_t *elm) {
	// 将elem插入listelm和listelm->next之间,换句话说，就是将elm插在listelm之后
 ...
 * */
// 好吧，原来是将listelm首先从原来的list中删除，然后又初始化了一遍
static inline void
